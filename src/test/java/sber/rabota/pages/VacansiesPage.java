...
import sber.rabota.pages.elements.Button;
import java.util.List;
import static com.codeborne.selenide.Condition.visible;
import static com.codeborne.selenide.Selenide.*;

public class VacansiesPage {
    private ElementsCollection errorMessages = $$(".styled__Error-sc-10rv8xs-0");
    ...
    public VacansiesPage clickOnDataProcessingConsentСheckbox() {
        checkboxAgree.click();
        return this;
    }
    ...
    public void checkValidationOfFieldsWithEmptyValues(List<String> errorTexts) {
